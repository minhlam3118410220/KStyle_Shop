                            ...
                            <table class="table-shopping-cart">
                                ...
                                @foreach($products as $key => $product)
                                    ...
                                    <tr class="table_row">
                                        ...
                                        <td class="column-3 cl3">${{ number_format($price, 0, '', '.') }}</td>
                                        <td class="column-4">
                                            <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                                ...
                                                <input class="mtext-104 cl8 txt-center num-product" type="number"
                                        ...
                                        <td class="p-r-15 ">
                                            <a class="cl3" href="/carts/delete/{{ $product->id }}">Del</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
                        ...
                        <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                            ...
                            <div class="size-100 p-r-18 p-r-0-sm w-full-ssm">
                                ...
                                <div class="p-t-15">
                                    ...
                                    <div class="bor8 bg0 m-b-12">
                                        <textarea class="cl8 plh3 size-111 p-lr-15" name="content" placeholder="Message"></textarea>
                                    </div>
...
@else
    <div class="text-center p-t-130 p-b-85"><h2>CART EMPTY</h2></div>
@endif
@endsection