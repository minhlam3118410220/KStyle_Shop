        ...
        <div class="wrap-slick1">
            <div class="slick1">
                ...
                @foreach($sliders as $slider)
                    ...
                    <div class="item-slick1 m-t-80" style="background-image: url({{ $slider->thumb }});">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="/template/images/banner-k01.jpg" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="/template/images/banner-k02.jpg" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="/template/images/banner-k03.jpg" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="/template/images/banner-k04.jpg" alt="IMG-BANNER">
        ...
        <div class="container">
            ...
            <div class="flex-w flex-sb-m p-b-52">
                <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                    ...
                    <a href="/danh-muc/6-tops.html">
                        <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 " data-filter="*">
                            Tops
                        </button>
                    </a>
                     <a href="/danh-muc/1-botttoms.html">
                        <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 " data-filter="*">
                            Bottoms
                        </button>
                    </a>
                    <a href="/danh-muc/9-outerwears.html">
                        <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 " data-filter="*">
                            Outerwears
                        </button>
                    </a>
                    <a href="/danh-muc/8-accessories.html">
                        <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 " data-filter="*">
                            Accessories
                        </button>
                    </a>
